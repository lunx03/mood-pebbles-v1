...
const CollectionView: React.FC<CollectionProps> = ({ 
  ...
  return (
    <div className="flex-1 flex flex-col antialiased">
      ...
      <main className="pt-32 pb-48 px-6 max-w-md mx-auto w-full">
        {!viewingArchive && (
                      ...
                      <div className="absolute -left-4 inset-y-0 flex items-center">
                         {idx > 0 && (
                          <button 
                            ...
                            className="w-8 h-8 bg-white dark:bg-zinc-800 rounded-full shadow-md flex items-center justify-center text-muted"
                          >
